...
public class User implements Serializable {
	...
	public String toString() {
		return "User [id=" + id + ", address=" + address + ", city=" + city + ", email=" + email + ", employeeid="
				+ employeeid + ", employeelevel=" + employeelevel + ", enabled=" + enabled + ", username=" + username
				+ ", password=" + password + ", phonenumber=" + phonenumber + ", bankaccountnumber=" + bankaccountnumber
				+ ", birthdate=" + birthdate + ", gender=" + gender + ", hiredate=" + hiredate + ", maritalstatus="
				+ maritalstatus + ", birthcertid=" + birthcertid + ", driverslicenseid=" + driverslicenseid
				+ ", passportid=" + passportid + ", ssnitid=" + ssnitid + ", votersid=" + votersid
				+ ", userdepartments=" + userdepartments + ", userroles=" + userroles + "]";
	}
